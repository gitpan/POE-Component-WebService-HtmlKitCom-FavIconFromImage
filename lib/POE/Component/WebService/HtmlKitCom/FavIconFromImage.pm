...
the C<event> argument to C<Efavicon()> method/event will recieve input
...
Please report any bugs or feature requests to C<bug-poe-component-webservice-htmlkitcom-faviconfromimage at rt.cpan.org>, or through
the web interface at L<http://rt.cpan.org/NoAuth/ReportBug.html?Queue=POE-Component-WebService-HtmlKitCom-FavIconFromImage>.  I will be notified, and then you'll
...
You can find documentation for this module with the perldoc command.
    ...
    perldoc POE::Component::WebService::HtmlKitCom::FavIconFromImage
...
L<http://rt.cpan.org/NoAuth/Bugs.html?Dist=POE-Component-WebService-HtmlKitCom-FavIconFromImage>

=item * AnnoCPAN: Annotated CPAN documentation

L<http://annocpan.org/dist/POE-Component-WebService-HtmlKitCom-FavIconFromImage>

=item * CPAN Ratings

L<http://cpanratings.perl.org/d/POE-Component-WebService-HtmlKitCom-FavIconFromImage>

=item * Search CPAN

L<http://search.cpan.org/dist/POE-Component-WebService-HtmlKitCom-FavIconFromImage>
